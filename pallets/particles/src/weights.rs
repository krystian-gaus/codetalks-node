...
// pallet_particles
// --output
// pallets/particles/src/weights.rs
...
/// Weight functions needed for pallet_particles.
...
/// Weights for pallet_particles using the Substrate node and recommended hardware.
